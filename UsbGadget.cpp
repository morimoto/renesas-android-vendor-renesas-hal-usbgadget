...
#define LOG_TAG "android.hardware.usb.gadget@1.0-service.renesas"
...
UsbGadget::UsbGadget()
  ...
  if (access(OS_DESC_PATH, R_OK) != 0) ALOGE("configfs setup not done yet: %s", OS_DESC_PATH);
}
